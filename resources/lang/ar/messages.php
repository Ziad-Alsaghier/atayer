<?php return array (
  ...
  'you_can_not_edit_this_zone_please_add_a_new_zone_to_edit' => 'you can not edit this zone please add a new zone to edit',
  ...
  'self_delivery_hint' => 'عندما يتم تمكين هذا الخيار ، تحتاج المطاعم إلى تسليم الطلبات بنفسها أو بواسطة رجل التوصيل الخاص بها. ستحصل المطاعم أيضًا على خيار لإضافة رجل توصيل خاص بها من لوحة المطعم.',
  ...
  'The chosen model will confirm the order first. For example  if you choose the delivery confirmation model then the delivery men will get the orders before the restaurants and confirm for delivery and after confirmation by the delivery men  the restaurants will get the order for processing.' => 'سيؤكد النموذج المختار الطلب أولاً. على سبيل المثال ، إذا اخترت نموذج تأكيد التسليم ، فسيحصل رجال التوصيل على الطلبات قبل المطاعم ويؤكدون التسليم وبعد التأكيد من قبل رجال التوصيل ، ستحصل المطاعم على أمر المعالجة.',
  ...
  'Customer Can Earn & Buy From Wallet' => 'يمكن للعميل أن يكسب ويشتري من المحفظة',
  ...
  'Customer Can Earn Loyalty Point' => 'يمكن للعميل ربح نقاط الولاء',
  ...
  'App Store Button Disabled for Delivery Man' => 'زر متجر التطبيقات معطل لرجل التوصيل',
  ...
  'With_this_feature _customers_can_place_an_order_by_uploading_prescription._Stores_can_enable/disable_this_feature_from_the_store_settings_if_needed.' => 'باستخدام هذه الميزة ، يمكن للعملاء تقديم طلب عن طريق تحميل الوصفة الطبية. يمكن للمتاجر تمكين / تعطيل هذه الميزة من إعدادات المتجر إذا لزم الأمر.',
  ...
  'With_this_feature _customers_can_choose_their_preferred_delivery_slot._Customers_can_select_a_delivery_slot_for_ASAP_or_a_specific_date_(within_2_days_from_the_order).' => 'باستخدام هذه الميزة ، يمكن للعملاء اختيار مكان التسليم المفضل لديهم. يمكن للعملاء تحديد فترة تسليم في أسرع وقت ممكن أو تاريخ محدد (في غضون يومين من الطلب).',
  ...
  'Tips_for_Deliveryman' => 'تبس للدليفرى',
