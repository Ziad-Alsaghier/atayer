...
<?php
    ...
    $toggle_dm_registration_setting = \App\Models\BusinessSetting::where(['key' => 'toggle_dm_registration'])->first();
    $toggle_dm_registration = $toggle_dm_registration_setting->value ?? '0';

    $toggle_store_registration_setting = \App\Models\BusinessSetting::where(['key' => 'toggle_store_registration'])->first();
    $toggle_store_registration = $toggle_store_registration_setting->value ?? '0';
...
<link rel="stylesheet" href="{{ asset('assets/admin/css/toastr.css') }}">
    ...
    <!-- Odometer -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/odometer.js/0.4.8/odometer-theme-default.min.css" />

    <!-- Toastr -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css" />

    <!-- Your custom CSS (still local) -->
    <link rel="stylesheet" href="{{ asset('assets/landing/css/customize-animate.css') }}" />
