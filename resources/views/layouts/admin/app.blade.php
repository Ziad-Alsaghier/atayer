...
<!-- Favicon -->
<link rel="shortcut icon" href="{{ asset('storage/business/' . ($logo ?? 'favicon.png')) }}">
<link rel="icon" type="image/x-icon" href="{{ asset('storage/business/' . ($logo ?? 'favicon.png')) }}">
...
{{--<nav class="floating-menu">
    <ul class="main-menu">
        @foreach T(\App\Models\Module::notParcel()->get() as $module)
        <li>
            <a class="p-2 navbar-dropdown-account-wrapper" href="javascript:;" onclick="set_filter('{{url()->full()}}',{{$module->id}},'module_id')" title="{{$module->module_name}}">
                <img class="avatar avatar-sm avatar-circle" src="{{asset('storage/app/module')}}/{{$module['thumbnail']}}" alt="{{$module->module_name}}" width="20">
            </a>
        </li>
        @endforeach
        <li>
            <a class="p-2 navbar-dropdown-account-wrapper" href="javascript:;" onclick="set_filter('{{url()->full()}}','','module_id')" title="{{$module->module_name}}">
                <img class="avatar avatar-sm avatar-circle" src="{{asset('storage/app/business/'.$logo??'')}}" alt="{{translate('messages.all')}} {{translate('messages.module')}}" width="20">
            </a>
        </li>
    </ul>
