                        ...
                        <div class="card-body">
                            ...
                            <div class="lang_form" id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[]" id="default_title" class="form-control" placeholder="{{translate('messages.new_food')}}" value="{{$campaign?->getRawOriginal('title')}}" required oninvalid="document.getElementById('en-link').click()">
                                </div>
                            ...
                            <div id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[]" class="form-control" placeholder="{{translate('messages.new_food')}}" value="{{$campaign['title']}}" required>
                                </div>
                                <input type="hidden" name="lang[]" value="default">
                                <div class="form-group pt-2 mb-0">
