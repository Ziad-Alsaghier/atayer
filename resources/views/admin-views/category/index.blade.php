                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group lang_form" id="default-form">
                                ...
                                <input type="text" name="name[]" class="form-control" placeholder="{{translate('messages.new_category')}}" maxlength="191" required oninvalid="document.getElementById('en-link').click()">
                            </div>
