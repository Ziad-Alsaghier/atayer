                                    ...
                                    <div class="d-flex __gap-12px mt-4">
                                        <label class="__custom-upload-img mr-lg-5">
                                            ...
                                            <center>
                                                ...
                                                class="img--vertical"
                                                id="viewer"
                                                src="{{ asset('storage/business/' . ($logo ?? 'upload-img.png')) }}"
                                                alt="logo image"
                                                onerror="this.onerror=null; this.src='{{ asset('public/assets/admin/img/upload-img.png') }}';">
                                        ...
                                        <label class="__custom-upload-img">
                                            ...
                                            <center>
                                                ...
                                                class="img--110"
                                                id="iconViewer"
                                                src="{{ asset('storage/business/' . ($icon ?? 'upload-img.png')) }}"
                                                alt="Fav icon"
                                                onerror="this.onerror=null; this.src='{{ asset('public/assets/admin/img/upload-img.png') }}';">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        {{-- <select name="" class="form-control js-select2-custom"
                                            id="currency_symbol_position">
                                            <option value="left"
                                                {{ $currency_symbol_position ? ($currency_symbol_position->value == 'left' ? 'selected' : '') : '' }}>
                                                {{ translate('messages.left') }}
                                                ({{ \App\CentralLogics\Helpers::currency_symbol() }}123) </option>
                                            <option value="right"
                                                {{ $currency_symbol_position ? ($currency_symbol_position->value == 'right' ? 'selected' : '') : '' }}>
                                                {{ translate('messages.right') }}
                                                (123{{ \App\CentralLogics\Helpers::currency_symbol() }}) </option>
                                        </select> --}}
                                        <div class="resturant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="left" name="currency_symbol_position" checked="">
                                                <span class="form-check-label">
                                                    ($) {{translate('Left')}}
                                                </span>
                                            </label>
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="right" name="currency_symbol_position">
                                                <span class="form-check-label">
                                                    {{translate('Right')}} ($)
                                                </span>
                                            </label>
