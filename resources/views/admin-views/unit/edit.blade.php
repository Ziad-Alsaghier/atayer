                                    ...
                                    @if($language)
                                        ...
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="unit[]" id="default_title" class="form-control" placeholder="{{translate('messages.unit_name')}}" value="{{$unit?->getRawOriginal('unit')}}" maxlength="191" oninvalid="document.getElementById('en-link').click()">
                                            </div>
