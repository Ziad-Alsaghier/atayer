                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="lang_form" id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" id="default_name" class="form-control" placeholder="{{translate('messages.new_food')}}" value="{{$parcel_category?->getRawOriginal('name')}}" required oninvalid="document.getElementById('en-link').click()">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="description[]" class="form-control ckeditor" required oninvalid="document.getElementById('en-link').click()">{!! $parcel_category?->getRawOriginal('description') !!}</textarea>
                                </div>
                            </div>
                                @foreach(json_decode($language) as $lang)
                                    <?php
