            ...
            <div class="card-body">
                <form action="{{route('vendor.addon.update',[$addon['id']])}}" method="post">
                    ...
                    <div class="form-group lang_form" id="default-form">
                        ...
                        <input type="text" name="name[]" class="form-control" placeholder="{{translate('messages.new_addon')}}" maxlength="191" value="{{$addon->getRawOriginal('name')}}" required oninvalid="document.getElementById('en-link').click()">
                    </div>
