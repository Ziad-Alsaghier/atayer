                        ...
                        <form action="{{route('vendor.addon.store')}}" method="post">
                            ...
                            @if($language)
                                ...
                                <div class="form-group lang_form" id="default-form">
                                    ...
                                    <input type="text" name="name[]" class="form-control" placeholder="{{translate('messages.new_addon')}}" maxlength="191" required oninvalid="document.getElementById('en-link').click()">
                                </div>
